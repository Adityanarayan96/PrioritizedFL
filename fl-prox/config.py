...
parser.add_argument('-eps-drop', type=int, default = 1500) #After how long does epsilon become smaller (So you only use priority clients)
...
parser.add_argument('--prox_term', type=float, default=1.0)
