...
experiments = [
    ...
    # "-data fmnist -availability always -lr-warmup 0.1 -method Local,FedALIGN -seeds 1 -iters-warmup 100 -iters-total 1000 -lr 0.1 -include-gradient-threshold 0.2 -include-gradient-threshold_later 0.2 -total-clients 60 -priorityfrac 0.035 ",
