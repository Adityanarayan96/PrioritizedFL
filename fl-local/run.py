...
experiments = [
    ...
    "-data fmnist -availability always -lr-warmup 0.1 -method Local,FedALIGN -seeds 1,2,3,4,5 -iters-warmup 0 -iters-total 1000 -lr 0.1 -include-gradient-threshold 0.2 -include-gradient-threshold_later 0.2 -total-clients 60 -priorityfrac 0.35 ",
    "-data emnist -availability always -lr-warmup 0.1 -method Local,FedALIGN -seeds 1,2,3,4,5 -iters-warmup 0 -iters-total 1000 -lr 0.1 -include-gradient-threshold 0.2 -include-gradient-threshold_later 0.2 -total-clients 60 -priorityfrac 0.35 ",
    "-data cifar10 -availability always -lr-warmup 0.1 -method Local,FedALIGN -seeds 1,2,3,4,5 -iters-warmup 100 -iters-total 1000 -lr 0.01 -include-gradient-threshold 0.2 -include-gradient-threshold_later 0.2 -total-clients 60 -priorityfrac 0.35 ",
