...
parser.add_argument('-availability', type=str, default='always')  #always, uniform
...
parser.add_argument('-sampled-fraction-pr', type=float, default=0.3) #Fraction of priority clients included per round, only used with uniform
parser.add_argument('-sampled-fraction-fr', type=float, default=0.3) #Fraction of free clients included per round, only used with uniform
